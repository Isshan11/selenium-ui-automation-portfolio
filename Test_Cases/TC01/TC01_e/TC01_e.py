...
from pages import minors_plan_page as mpp
...
def Go_to_Minors_Plan_Page():
    time.sleep(2)
    SafeStep(ps.XPATH_SEE_PLANS_BTN,mpp.XPATH_HEADER,"Minors Plan","Build your youth plan")

def Go_to_SelectNumber_Page():
    time.sleep(2)
    SafeStep(mpp.XPATH_CONTINUE_BTN,sn.XPATH_HEADER,"Select Number","Find a number you love")

def Go_To_Login_Page():
    SafeStep(sn.XPATH_THIS_NUMBER_BTN,0,0,0)
    time.sleep(3)
...
def Go_To_Address_Map_Page():
    SafeStep(lp.XPATH_CONFIRM_EMAIL_BTN,am.XPATH_HEADER,"Address Map","We'll deliver your SIM")
...
csv_input(file_name)
#Main Mobile Plan - Youth Plan - order
