...
def Go_To_Login_Page():
    SafeStep(cyi.XPATH_CONTINUE_BTN,lp.XPATH_HEADER,"Login Page","It's nice to meet you!")
    time.sleep(3)
...
# Main mobile plan flow - 1 Month - Change to 12 Month - Go with Phone - Order