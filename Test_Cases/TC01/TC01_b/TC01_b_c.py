...
def Go_To_PlanSelection_Page():
    ...
    SafeStep(ps.XPATH_6MONTH_PLAN_BTN,0,0,0)
...
def Go_to_SelectNumber_Page():
    time.sleep(2)
    SafeStep(po.XPATH_GO_12_MONTH_BTN,sn.XPATH_HEADER,"Select Number","Find a number you love")
...
def Go_To_Login_Page():
    SafeStep(ds.XPATH_CHOOSE_NO_IPHONE,lp.XPATH_HEADER,"Login Page","It's nice to meet you!")
    time.sleep(3)
...
# Main mobile plan flow - 6 Month - Change to 12 Month - Go withOut Phone - Order