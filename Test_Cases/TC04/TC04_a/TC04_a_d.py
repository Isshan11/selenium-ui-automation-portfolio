...
def Go_To_Login_Page():
    SafeStep(po.XPATH_STAY_MONTHLY_HOME_INTERNET_BTN,lp.XPATH_HEADER_HOME_INTERNET,"Login","It's nice to meet you!")
    time.sleep(3)
...
def Go_To_Delivery_Page():
    time.sleep(1)
    SafeStep(lp.XPATH_CONFIRM_EMAIL_BTN,0,0,0)
    time.sleep(10)
    SafeStep(0,dp.XPATH_HEADER,"Delivery","Where do you want your order delivered?")

def Go_To_Deliver_Type():
    SafeStep(dp.XPATH_NEW_LOCATION_BTN,aa.XPATH_HEADER_HOME_INTERNET,"Deliver Type","Where do you want your order delivered?")
...
# Home Internet Plan - With Location - 1 Month - Stay 1 Month - change location - order
