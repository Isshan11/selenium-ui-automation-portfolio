...
def Go_To_Login_Page():
    SafeStep(p.XPATH_BUY_THIS_BTN,lp.XPATH_HEADER_HOME_INTERNET,"Login","It's nice to meet you!")
    time.sleep(3)
...
# Home Internet Plan - With Location - 12 Month - change location - order
